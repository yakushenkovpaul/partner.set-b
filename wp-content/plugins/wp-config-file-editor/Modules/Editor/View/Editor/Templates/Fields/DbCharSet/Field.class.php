...
class Field extends DropDownField {
	...
	*/
	public function getText() {
		return $this->__( 'Database Characters Set' );
	}
	...
	*/
	public function getTipText() {
		return $this->__( 'Was made available to allow designation of the database character set (e.g. tis620 for TIS620 Thai) to be used when defining the MySQL database tables.' );
	}
