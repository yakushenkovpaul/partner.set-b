...
$construction_landing_page_sections = array( 'banner', 'about', 'promotional', 'about2', 'promotional2', 'portfolio', 'services', 'clients', 'testimonials', 'contactform' );
...
get_header(); 
    if ( 'posts' == get_option( 'show_on_front' ) ) {
        ...
        foreach( $construction_landing_page_sections as $section ){ 
						...
						// echo '>>>construction_landing_page_ed_' . $section . '_section';
						// echo '[' . get_theme_mod( 'construction_landing_page_ed_' . $section . '_section' ) . ']<br/>';
