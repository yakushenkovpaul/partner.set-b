...
function construction_landing_page_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info = '';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Video Tutorial', 'construction-landing-page' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/documentation/construction-landing-page/' ) . '" target="_blank">' . __( 'here', 'construction-landing-page' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'construction-landing-page' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/previews/?theme=construction-landing-page' ) . '" target="_blank">' . __( 'here', 'construction-landing-page' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support Ticket', 'construction-landing-page' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/support-ticket/' ) . '" target="_blank">' . __( 'here', 'construction-landing-page' ) . '</a></span><br />';
	...
	$manager->add_section(
		new Construction_Landing_Page_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'https://raratheme.com/wordpress-themes/construction-landing-page-pro/'
			)
		)
	);
}