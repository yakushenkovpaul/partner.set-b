	...
	public function widget( $args, $instance ) {
        ...
        ?>
            ...
            <ul class="social-networks">
                ...
                <li><a href="<?php echo esc_url( $facebook ); ?>" target="_blank" title="<?php esc_attr_e( 'Facebook', 'construction-landing-page' ); ?>" class="fa fa-facebook"></a></li>

				<?php } if( $twitter ){ ?>

                <li><a href="<?php echo esc_url( $twitter ); ?>" target="_blank" title="<?php esc_attr_e( 'Twitter', 'construction-landing-page' ); ?>" class="fa fa-twitter"></a></li>

				<?php } if( $pinterest ){ ?>

                <li><a href="<?php echo esc_url( $pinterest ); ?>" target="_blank" title="<?php esc_attr_e( 'Pinterest', 'construction-landing-page' ); ?>" class="fa fa-pinterest-p"></a></li>

				<?php } if( $linkedin ){ ?>

                <li><a href="<?php echo esc_url( $linkedin ); ?>" target="_blank" title="<?php esc_attr_e( 'Linkedin', 'construction-landing-page' ); ?>" class="fa fa-linkedin"></a></li>

				<?php } if( $googleplus ){ ?>

                <li><a href="<?php echo esc_url( $googleplus ); ?>" target="_blank" title="<?php esc_attr_e( 'Google Plus', 'construction-landing-page' ); ?>" class="fa fa-google-plus"></a></li>

				<?php } if( $instagram ){ ?>

                <li><a href="<?php echo esc_url( $instagram ); ?>" target="_blank" title="<?php esc_attr_e( 'Instagram', 'construction-landing-page' ); ?>" class="fa fa-instagram"></a></li>

				<?php } if( $youtube ){ ?>

                <li><a href="<?php echo esc_url( $youtube ); ?>" target="_blank" title="<?php esc_attr_e( 'YouTube', 'construction-landing-page' ); ?>" class="fa fa-youtube"></a></li>

                <?php } if( $ok ){ ?>

                <li><a href="<?php echo esc_url( $ok ); ?>" target="_blank" title="<?php esc_attr_e( 'OK', 'construction-landing-page' ); ?>" class="fa fa-odnoklassniki"></a></li>

                <?php } if( $vk ){ ?>

                <li><a href="<?php echo esc_url( $vk ); ?>" target="_blank" title="<?php esc_attr_e( 'VK', 'construction-landing-page' ); ?>" class="fa fa-vk"></a></li>

                <?php } if( $xing ){ ?>

                <li><a href="<?php echo esc_url( $xing ); ?>" target="_blank" title="<?php esc_attr_e( 'Xing', 'construction-landing-page' ); ?>" class="fa fa-xing"></a></li>
